...
Zitate_Liste = [line.rstrip('\n') for line in open(pfad +"/sources/Zitate.txt", encoding="utf8")]
Luegen_Liste = [line.rstrip('\n') for line in open(pfad +"/sources/Luegen.txt", encoding="utf8")]
Soundliste = [line.rstrip('\n') for line in open(pfad +"/sources/sounds.txt", encoding="utf8")]
